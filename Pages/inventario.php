...
<body>
  <header class="header">
    ...
    <nav class="nav">
      <ul class="nav-ul">
        <li><a href="../Pages/inventario/consultar.php">CONSULTAR</a></li>
      </ul>
    </nav>
  </header>
  <section class="hero">
  ...
  <section class="options">
    <a href="../Pages/inventario/consultar.php" class="option-card">
      <div class="card-item">
  ...
  <footer class="footer">
    ...
    <a href="pages/../../php/salir.php" class="btn_salir">Salir</a>
  </footer>
</body>
